...
Tray *createtray (void *monitor, int height, int iconsize, int spacing,
                  uint32_t *colorscheme, const char **fonts,
                  const char *fontattrs, TrayNotifyCb cb, Watcher *watcher);
